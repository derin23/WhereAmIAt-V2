 ...
 const Home = props => {
  ...
  fetch(myURL)
    ...
    //alert(json.results[0].annotations.OSM.url);
     var doSee = window.confirm("do you want to see a map your current location");
     if(doSee == true)
                  ...
                  >
                    <div className="navbar-nav">
                      ...
                      <a
                        ...
                        href="https://github.com/derin23"
                      >
                        Github
                      </a>
                      <a
                        className="nav-item nav-link"
                        href="https://www.linkedin.com/in/derin-joseph-2046b9164/"
                      >
                        Linkedin
                      </a>
                    </div>
                      ...
                      <div className="card">
                        ...
                        <div className="card-body">
                          ...
                          <p className="text-center">
                            Click the button to get your current
                            address.
                          </p>
